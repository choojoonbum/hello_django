...
class TestView(TestCase):
    def setUp(self):
        ...
        self.category_programming = Category.objects.create(name='programming1', slug='programming1')
        ...
        self.post_001 = Post.objects.create(
            title='첫 번째 포스트입니다.',
            content='Hello World. We ard the world.',
    ...
    def navbar_test(self, soup):
        ...
        logo_btn = navbar.find('a', text='Hello Django')
